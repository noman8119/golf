...
<Heading size="xl" fontWeight="medium" textAlign="center">Sign in to your account</Heading>
         ...
         <Text textAlign="center" color="red">No Account Found Please Try Again</Text>
         <SimpleGrid columns={1}  rowGap={6} w="full" textAlign="center">
          <GridItem colSpan={1}>
            <FormControl textAlign="center">
              <Input placeholder="480-555-7890"  className='login-input' variant='flushed' textAlign="center" height="60px" width="318px" fontSize="lg"/>
              <Link href="/grid">
