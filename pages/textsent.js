...
<VStack  className='textsent'>
         ...
         <Heading  textAlign="center" size="xl">Text Link Sent</Heading>
         <Text fontWeight="medium" fontSize="xl">Click the link sent to your phone</Text>
         <SimpleGrid columns={1} columnGap={1} rowGap={6} w="full">
          <GridItem colSpan={1}>
            <FormControl textAlign="center">
              ...
              <Text fontSize="md" pt="2" fontWeight="medium">{"Didn't receive a link?"}<Link href="/"><span className="signin"> Resend Now</span></Link></Text>
            </FormControl>
          </GridItem>
         </SimpleGrid>
